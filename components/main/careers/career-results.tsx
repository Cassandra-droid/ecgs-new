    ...
    return (
      <div className="py-12 text-center">
        ...
        <p className="mb-6 text-muted-foreground">
          We couldn't find any career matches based on your criteria. Try
          adjusting your skills or interests.
        </p>
      </div>
    );
  }
      ...
      {results && results.length > 0 ? (
          ...
          {results.map((career, index) => (
            <Card key={index} className="h-full">
              ...
              <CardFooter className="flex justify-between border-t p-4">
                <Button
                  variant="outline"
                  onClick={() => toggleJobDetails(career.title)}
                  className="w-full"
                >
                ...
                <div className="border-t px-6 pb-6 pt-4">
                  ...
                  <div className="space-y-3">
                    <div className="rounded-md bg-muted p-3">
                      <div className="mb-1 flex justify-between">
                        <span className="font-medium">
                          {career.title} at TechCorp
                        </span>
                        <Badge variant="outline">Remote</Badge>
                      </div>
                      <p className="mb-2 text-sm text-muted-foreground">
                        Join our team as a {career.title} and work on
                    ...
                    <div className="rounded-md bg-muted p-3">
                      <div className="mb-1 flex justify-between">
                        <span className="font-medium">
                          Senior {career.title} at InnovateCo
                        </span>
                        <Badge variant="outline">Hybrid</Badge>
                      </div>
                      <p className="mb-2 text-sm text-muted-foreground">
                        Looking for an experienced {career.title} to lead our
                        growing team.
                      </p>
        ...
        <div className="py-8 text-center">
          <p className="text-muted-foreground">
            No career matches found. Try adjusting your criteria.
          </p>
        </div>
      )}
    </div>
