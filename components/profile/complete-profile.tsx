...
import { Share2, Download, Mail, Phone, Globe, MapPin, Briefcase, GraduationCap } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Complete Profile</CardTitle>
          <CardDescription>Review your complete profile information</CardDescription>
        </CardHeader>
        <CardContent>
